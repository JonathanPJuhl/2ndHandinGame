...
public class NewPlayerMove : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            transform.Rotate(Vector3.up * Input.GetAxis("Mouse X") * Cam.GetComponent<Cam>().sensivity * Time.deltaTime);
            ...
            transform.rotation = Quaternion.Lerp(transform.rotation, CamRotation, 1f);
